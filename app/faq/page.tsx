  ...
  return (
    <div className="max-w-3xl mx-auto px-4 space-y-10 py-12">
      ...
      <div className="space-y-4">
        ...
        <QA q="Are you affiliated with Disney?" a="No. AnaheimCrowds is an independent planning site built for people who want a clearer read on dates, crowd behavior, and what each trip choice gives up." />
      </div>
    </div>
  );
}
